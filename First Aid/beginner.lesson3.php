        ...
        <div class="container mt-5" style="margin: 158px 48px;">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    ...
                    <h1>Beginner Lesson 3: Bleeding</h1>
                        <p> </p>
                        <p> </p>
                        <img src="bgnL3S (1).jpg" alt="step 4 Image" width="500" height="450">
                        <img src="bgnL3S (7).jpg" alt="step 2 Image" width="500" height="450"">
                        <img src="bgnL3S (6).jpg" alt="step 4 Image" width="500" height="450">
                        
                        <img src="bgnL3S (5).jpg" alt="step 4 Image" width="500" height="450">
                        <img src="bgnL3S (4).jpg" alt="step 3 Image" width="500" height="450"">
                        <img src="bgnL3S (2).jpg" alt="step 1 Image" width="500" height="450"">
                        <img src="bgnL3S (3).jpg" alt="step 2 Image" width="500" height="450"">
                        

    
    <p> </p>
    <p>Watch these:</p>
    <iframe width="500" height="300" src="https://www.youtube.com/embed/V8KiNURVjgk?si=bv8lkDhkPJwh92Zp" frameborder="0" allowfullscreen></iframe>
        <a class="btn btn-primary mr-2" href="beginner.lesson3.quiz.php">QUIZ</a>
