...
<li class="nav-item">
<a class="nav-link" href="course2.html">Course</a>
</li>
          <li class="nav-item">
  ...
  <section id="home" class="py-5" style="background-image: url('abcdefg.jpg'); background-size: cover; background-position: center;">
   ...
   <section id="advance" class="py-5 bg-dark">
  <div class="container mt-5" style="margin: 158px 48px;">
    <div class="row justify-content-center">
      <div class="col-md-6 text-center">
        <div class="content-box">
    <h1 class="text-center">Advance Lessons</h1>
    
    <a class="btn btn-primary mr-2" href="advance.lesson1.php">Lesson 1</a>
    <a class="btn btn-primary mr-2" href="advance.lesson2.php">Lesson 2</a>
    <a class="btn btn-primary mr-2" href="advance.lesson3.php">Lesson 3</a>
    <a class="btn btn-primary mr-2" href="advance.final.quiz.php">Final Quiz</a>
