        ...
        <div class="container mt-5" style="margin: 158px 48px;">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    ...
                    <h1>Beginner Lesson 2: Shock</h1>
                        <p> </p>
                        <p> </p>
                        <img src="bgnL2S (1).jpg" alt="step 4 Image" width="500" height="450">
                        <img src="bgnL2S (6).jpg" alt="step 4 Image" width="500" height="450">
                        
                        <img src="bgnL2S (5).jpg" alt="step 4 Image" width="500" height="450">
                        <img src="bgnL2S (4).jpg" alt="step 3 Image" width="500" height="450"">
                        <img src="bgnL2S (3).jpg" alt="step 2 Image" width="500" height="450"">
                        <img src="bgnL2S (2).jpg" alt="step 1 Image" width="500" height="450"">

    
    <p> </p>
    <p>Watch these:</p>
    <iframe width="500" height="300" src="https://www.youtube.com/embed/61urGQrmeNM?si=LXLsdDh5yIk_UhM9" frameborder="0" allowfullscreen></iframe>
        <a class="btn btn-primary mr-2" href="beginner.lesson2.quiz.php">QUIZ</a>
