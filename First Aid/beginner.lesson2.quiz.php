...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    <div class="content-box">
                        ...
                        <h1>Beginner Lesson 2 Quiz :  Shock</h1>
                        <div class="question" id="question1">
                            <p> What is the first step to take when providing first aid for someone who may be in shock?</p>
                            <button class="answer-button" data-correct="Call emergency services" onclick="checkAnswer(this)">Call emergency services</button>
                            <button class="answer-button" data-correct="Call emergency services" onclick="checkAnswer(this)">Lay them down</button>
                            <button class="answer-button" data-correct="Call emergency services" onclick="checkAnswer(this)">Give the person something to drink</button>
                            <button class="answer-button" data-correct="Call emergency services" onclick="checkAnswer(this)">Apply pressure to the wound</button>
                        </div>

                        <div class="question" id="question2">
                            <p>How should you position a person suspected of being in shock?</p>
                            <button class="answer-button" data-correct="Lay them flat on their back" onclick="checkAnswer(this)">Lay them flat on their back</button>
                            <button class="answer-button" data-correct="Lay them flat on their back" onclick="checkAnswer(this)">Elevate legs</button>
                            <button class="answer-button" data-correct="Lay them flat on their back" onclick="checkAnswer(this)">Sit them upright</button>
                            <button class="answer-button" data-correct="Lay them flat on their back" onclick="checkAnswer(this)">Place them in the recovery position</button>
                        </div>

                        <div class="question" id="question3">
                            <p> Which of the following conditions may lead to shock?</p>
                            <button class="answer-button" data-correct="Severe allergic reaction (anaphylaxis)" onclick="checkAnswer(this)">Severe allergic reaction (anaphylaxis)</button>
                            <button class="answer-button" data-correct="Severe allergic reaction (anaphylaxis)" onclick="checkAnswer(this)">Broken bone</button>
    ...
    <footer class="bg-dark text-white text-center py-3">
        <div class="container">
            ...
            <p>Contact: 688 Beribadh Road Mohammadpur Call emergency services - 1207, Bangladesh</p>
